import{_ as p}from"./Popover-Bs-MC7Q-.js";const a={title:"Components/Popover",component:p,argTypes:{color:{table:{type:{summary:["string: info, error, warning, success, gray, red, yellow, orange, green, blue, indigo, purple, pink"]}},options:["info","error","warning","success","gray","red","yellow","orange","green","blue","indigo","purple","pink"],control:{type:"select"}},icon:{control:{type:"boolean"}}}},e={render:t=>({components:{Popover:p},setup:()=>({args:t}),template:`
